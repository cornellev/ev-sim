...
EXPLICIT_CPU_LIDAR_VERSION = "2"
EXPLICIT_CPU_LIDAR_CONFIG_HASH = "70349dfde6494414249bbcf6e1befc13ce82b817a63eb01baac4f5402ce62c31"
...
ROUTED_GPU_SENSOR_VERSION = "2"
ROUTED_GPU_SENSOR_CONFIG_HASH = "826f1285819e2c8c995f2f5f359add2beaf00a148878af0db1921e84895c9129"
...
DEFAULT_CPU_LIDAR_BACKEND = BackendSelection(
    CPU_LIDAR_KIND,
    CPU_LIDAR_CAPABILITY,
    CPU_LIDAR_VERSION,
    CPU_LIDAR_CONFIG_HASH,
)
EXPLICIT_CPU_LIDAR_BACKEND = BackendSelection(
    CPU_LIDAR_KIND,
    CPU_LIDAR_CAPABILITY,
...
ROUTED_GPU_SENSOR_BACKEND = BackendSelection(
    GPU_SENSOR_KIND,
    GPU_SENSOR_CAPABILITY,
