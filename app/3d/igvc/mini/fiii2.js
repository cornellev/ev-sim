...
import { OneWaySign } from "../../city/objects/OneWaySign";
...
const oneWayLL = convertStringToLatLng(`42°40'05.92"N 83°13'03.74"W`);

export async function FIII2(scene, data) {
    ...
    const oneWayGround = toScene(oneWayLL, baseOffset);
    data.objects().addObject(new OneWaySign(oneWayGround.clone(), 1));
