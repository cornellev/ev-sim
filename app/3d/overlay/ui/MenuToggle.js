...
export function MenuToggle({
    ...
    return (
        <button
            type="button"
            className={cn(
                "flex w-full items-center justify-between gap-2 rounded-lg border border-zinc-700/80 bg-zinc-900/85 px-2 py-1.5 text-left transition-colors hover:bg-zinc-800/90",
        ...
        >
            ...
            >
                <span
                    className={cn(
                        "mx-0.5 h-4 w-4 rounded-full bg-white shadow transition-transform",
