export function FlyoutPanel({ title, subtitle, children }) {
    return (
        <div className="menu-flyout-panel max-h-[min(680px,calc(100dvh-120px))] w-[320px] overflow-y-auto rounded-2xl border border-zinc-700/80 bg-zinc-950/85 p-3 text-zinc-100 shadow-[0_30px_80px_rgba(0,0,0,0.45)] backdrop-blur-2xl">
