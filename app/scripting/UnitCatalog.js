...
export const UNIT_CATALOG = [
    ...
    entry("texture1d", "Noise Texture (tex1d)", Noise, NoiseBlock),
    entry("texture1d", "Mask Texture (tex1d)", Mask, MaskBlock),
    entry("texture1d", "Multiply Textures (tex1d)", MultiplyTex, MultiplyTexBlock),
    entry("texture1d", "Scale Matrix (tex1d)", Scale, null),
