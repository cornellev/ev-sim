            ...
            <section className="relative min-h-0 flex-1">
                ...
                {dataset && (
                    <aside className="absolute right-3 top-3 w-[290px] overflow-hidden rounded-xl border border-zinc-700/80 bg-zinc-950/82 shadow-2xl backdrop-blur-xl">
                        ...
                        <div className="grid grid-cols-2 divide-x divide-zinc-800 border-b border-zinc-800"><InspectorMetric label="Step" value={exactSnapshot["simulation.step"] ?? "—"} /><InspectorMetric label="Status" value={exactSnapshot["simulation.status"] ?? "—"} /></div>
