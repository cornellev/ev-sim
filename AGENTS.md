...
PR 1 establishes the contract and characterization baseline. The next
implementation milestone is PR 2, extraction of the UI-independent fixed-step
kernel. Work on one numbered PR at a time; do not pull later sensor, Python,
MCP, or GPU scope into an earlier milestone.
